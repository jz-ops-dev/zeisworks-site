---
title: "How to Build a Tiered Med Spa Membership Program"
...
faq:
  ...
  - question: "How do I set membership prices without hurting my margins?"
    answer: "Start with your service cost, not your retail price. Calculate the actual cost to deliver each included service (product, provider time, overhead) and then price the membership so you retain at least a 40–50% margin. Build in the member discount after that math is done, not before."
  - question: "What should I do if a client wants to cancel their membership?"
    answer: "Don't just process the cancellation. Ask one question: what made this stop feeling worth it? You'll learn something useful either way. If there's a fixable reason (she didn't know about a benefit, had a scheduling issue), address it directly. Offer a pause option before a full cancel when appropriate."
  - question: "How do I reactivate clients who haven't booked in 6+ months?"
    answer: "Personal outreach beats broadcast emails. A short text or call referencing their name and last visit performs significantly better than a bulk promo. Give them a specific reason to come back: a new service, a seasonal treatment, a simple check-in. Make booking frictionless. Don't lead with a discount."
  - question: "How many membership tiers should a med spa offer?"
    answer: "Three is the right number for most practices. One entry-level tier, one mid-tier, and one premium. More than three creates decision fatigue and complicates your operations. Fewer than two leaves money on the table from clients who would spend more if given the option."
---
